...
config: {
 ...
 onStart: async function ({  }) { },
  ...
  if (event.body.indexOf("babu") == 0 || (event.body.toLowerCase() == "jaan") || (event.body.indexOf("Babu") == 0)) {
    var msg = {
      body: ` ${rand}`
    }
